...
const dictionary = {
  ...
  gameBoyGiftDescription: {
    en: "For my brother&apos;s birthday, I simulated a functioning Game Boy and a part of the game A Link To the Past with css and js. When you put in the appropriate code, it gives you a birthday gift. Special attention was given to the sound and visuals to maximize the nostalgia.",
    fr: "Pour l'anniversaire de mon frère, j'ai simulé un Game Boy et une partie du jeu A Link To the Past avec du css et du js. Quand vous entrez le code approprié, il vous donne un cadeau d'anniversaire. Une attention particulière a été portée au son et aux visuels pour maximiser la nostalgie.",
  },
...
const portfolioItems = [
  {
    ...
    videoPoster: "/media/nci-poster.jpg",
    bgColor: "#fff",
  ...
  },
  {
    ...
    videoPoster: "/media/digital-pride-fest-poster.jpg",
    bgColor: "#00b5b7",
  ...
  },
  {
    ...
    videoPoster: "/media/hyperloop-poster.jpg",
    bgColor: "#3f4456",
  ...
  },
  {
    ...
    videoPoster: "/media/5sg-poster.jpg",
    bgColor: "#fff",
  ...
  },
  {
    ...
    videoPoster: "/media/axels-adventure-poster.jpg",
    bgColor: "#043b3b",
    stack: ["js", "pixi"],
  ...
  },
  {
    ...
    videoPoster: "/media/game-boy-gift-poster.jpg",
    bgColor: "#18b490",
