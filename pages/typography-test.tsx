...
const Typography: NextPage = () => (
  <main>
    ...
    <p>
      ...
      additional levels of <code>&gt;</code>:
    </p>
    <blockquote>
    ...
    <p>
      ...
      <code>&lt;</code> and <code>&gt;</code>) are automatically converted into
      HTML entities. This makes it very easy to include example HTML source code
      using Markdown -- just paste it and indent it, and Markdown will handle
      the hassle of encoding the ampersands and angle brackets. For example,
      this:
    </p>
    <div>
      <pre>
        <code>
          ...
          <span title="©">&amp;copy;</span> 2004 Foo Corporation
          <span>
            <span>
              <span>&lt;/</span>div
            </span>
    ...
    <div>
      <pre>
        <code>
          tell application <span>&quot;Foo&quot;</span>
          <span>beep</span>
          <span>end</span> tell
        </code>
      </pre>
    ...
    <div>
      <pre>
        <code>
          ...
          <span>;</span>
          <span>{"}"}</span>
          <span>const</span> myName <span>=</span>{" "}
          <span>&quot;chris&quot;</span>
          <span>;</span>
          <span>console</span>
          <span>.</span>
          <span>log</span>
          <span>(</span>
          <span>&quot;Hello, &quot;</span> <span>+</span> myName<span>)</span>
          <span>;</span>
          <span>console</span>
          <span>.</span>
          <span>log</span>
          <span>(</span>
          <span>&quot;&lt;this is a tag/&gt;&quot;</span>
          <span>)</span>
        </code>
      </pre>
    </div>
    ...
    <p>
      ...
      <code>_</code> will be wrapped with an HTML <code>&lt;em&gt;</code> tag;
      double <code>*</code>&apos;s or <code>_</code>&apos;s will be wrapped with
      an HTML
    ...
    <h3>Header sizes</h3>
    <h1>Header 1 example size</h1>
    <h2>Header 2 example size</h2>
    <h3>Header 3 example size</h3>
    <h4>Header 4 example size</h4>
    <h5>Header 5 example size</h5>
  </main>
);
